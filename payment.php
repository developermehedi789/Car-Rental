    ...
    <div  class="row">
      <div class="col-md-6">
        <div class="payment-inner">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="payment-col"><img class="img-bottom-payment" src="assets/images/Payoneer-Card.jpg" alt=""  height="55"><br>Send money to the master card: Payoneer: mehedi_hasan@yahoo.com</div>
            </div>
          </div>
        </div>
      </div>
